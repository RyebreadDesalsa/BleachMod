...
namespace BleachMod.Content.Projectiles
{
	...
	public class GegetsuburiProjectile : ModProjectile
	{
		private const string ChainTexturePath = "BleachMod/Content/Projectiles/GegetsuburiProjectileChain"; // The folder path to the flail chain sprite
		...
		public override void AI()
		{
			...
			if (!player.active || player.dead || player.noItems || player.CCed || Vector2.Distance(Projectile.Center, player.Center) > 900f || player.altFunctionUse == 3)
			{
				Projectile.Kill();
				return;
			}
